...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/savedspot.css" />
    ...
    <div class="row">
      <div class="verticalnav col-3">
        ...
        >
          ...
          >
          <a class="nav-link" href="renthistory.php" aria-selected="false"
            >Renting History</a
          >
          <a class="nav-link" href="rentaccount.php" aria-selected="false"
            >Account Settings</a
          >
          <a class="nav-link active" href="savedspot.php" aria-selected="true"
