  ...
  <div class="row">
    <div class="verticalnav col-3">
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <a class="navbar-brand" href="rentprofile.php">
          <h3 style="color: aliceblue; margin-left: 1%">Hello <?php echo "$user" ?></h3>
          <a class="nav-link" href="renthistory.php" aria-selected="false">Renting History</a>
          <a class="nav-link" href="rentaccount.php" aria-selected="false">Account Settings</a>
          <a class="nav-link" href="savedspot.php" aria-selected="false">Saved Parking Spots</a>
      </div>
    </div>
    <div class="col-9">
