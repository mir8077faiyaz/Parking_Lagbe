...
<?php
include 'connect.php';
$email = $_GET['updatespot'];
$sql = "select PID,UID,Plocation,X(Pcoordinate) as latitude, Y(Pcoordinate) as longitude,Pphoto, Psize,Costhour,Security,Others from parkingspotdetails join user using(UID) where Email='" . mysqli_escape_string($conn, $email) . "'";
...
<script>
    ...
    function initMap() {
        ...
        var latitude = <?php echo $pxcoor; ?>;
        var longitude = <?php echo $pycoor; ?>;
    ...
    function saveLocation() {
        ...
        if (marker) {
            ...
            document.getElementById(xcoor).innerHTML = lat;
            document.getElementById(ycoor).innerHTML = lng;
        }
